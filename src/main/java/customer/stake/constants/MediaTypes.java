package customer.stake.constants;

public class MediaTypes {

    public static final String EBET_GATEWAY_CUSTOMER_DOCUMENT_REQUEST_JSON = "application/vnd.tipico.customer-document-request-v1+json";
    public static final String EBET_GATEWAY_CUSTOMER_DOCUMENT_STATUS_JSON = "application/vnd.tipico.customer-document-status-v1+json";
